do
  ...
  vim.keymap.set("n", "<leader>>", "<Cmd>BufferLineMoveNext<CR>", { noremap = true, silent = true, desc = "Move buffer right" })
  vim.keymap.set("n", "<leader><", "<Cmd>BufferLineMovePrev<CR>", { noremap = true, silent = true, desc = "Move buffer left" })

  vim.keymap.set("n", "<leader>bp", "<Cmd>BufferLineTogglePin<CR>", { noremap = true, silent = true, desc = "Move buffer left" })
