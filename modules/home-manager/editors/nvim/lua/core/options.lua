...
pcall(function() vim.o.fileencoding = 'utf-8' end) -- the encoding written to a file
...
vim.api.nvim_set_hl(0, 'LineNrAbove', { fg = '#9CB3C9' })
vim.api.nvim_set_hl(0, 'LineNrBelow', { fg = '#9CB3C9' })
